			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							if($res = $conn->query($w)){
								...
								while($rowq = $res->fetch_array()){
									...
									echo '<div>'.$a.'.) '.$rowq['app_name'].'</div>';
									if($rowq['app_price']!=NULL){
										echo '<div><strong>฿'.$rowq['app_price'].'.00</strong></div>';
									}else{
							...
							<div class="order-col">
								...
								<?php
												...
												if($res = $conn->query($w)){
													...
													if($p!=0){
														echo '<div><strong class="order-total">฿'.$p.'.00</strong></div>';
													}
													else{
														echo'<div><strong class="order-total">FREE</strong></div>';
													}
												}
											?>
							</div>
						...
						<?php 
							//$urlcheckout = 'index.php?checkout=yes';
							$urlcheckout = 'card.php';
						?>
						<a href=<?php echo $urlcheckout; ?> class="primary-btn order-submit">Place order</a>
					</div>
					<!-- /Order Details -->
				</div>
				<!-- /row -->
