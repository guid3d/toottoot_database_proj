...
<div id="breadcrumb" class="ass">
        ...
        <div class="container">
            ...
            <table style="width:100%;border: 1px solid">
					...
					<col width="200px">
                    <col width="200px">
					<th style="background-color:#ddd;">Application</th>
					<th style="background-color:#ddd;">Price(฿)</th>
                    <th style="background-color:#ddd;">Date</th>
                    <th style="background-color:#ddd;">Download</th>
                    <?php
                    $q = 'SELECT * FROM receipt r, applications a where r.app_id = a.app_id AND r.user_id = "' . $_SESSION['id'] . '"';
                    $result = $conn->query($q);
                    if (!$result) {
                    ...
                    while ($row = $result->fetch_array()) { ?>
                        <tr>
							...
							<td><?= $price?></td>
							<td><?= $row['r_date'] ?></td>
                            <td><a href="#" style="text-align:center;">Download</a></td>
                        </tr>
                    <?php } ?>
        </table>
        </div>
