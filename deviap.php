...
<body>
        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li  class="active"><a href="deviap.php">IAP Management</a></li>
                </ul>
                <!-- /NAV -->
            </div>
            <!-- /responsive-nav -->
    ...
    <div id="top" >
    <br>
    <h3 style="margin-left:5%">Welcome to In App Purchase management!</h3>
        <div class="button_cont" align="right"><a class="example_f" href="devaddnewiap.php" ><span>Add New IAP</a></div>
    </div>
    <!-- BREADCRUMB -->
    <div id="breadcrumb" class="section">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12" >
                    <h3 style="margin-left:2%">Your In App Purchases</h3>
                    <table class="basic_info">
                        <tr>
                            <td>App Name</td>
                            <td>IAP Description</td>
                            <td>Price</td>
                        ...
                        $sql = "SELECT app_name,iap_desc,iap_id,price FROM `inapp_purchase` i JOIN applications a ON i.app_id = a.app_id  \n"
                        ...
                        if ($res) {
                            while ($row = $res->fetch_assoc()) {
                                ...
                                echo '<td> ' . $row['iap_desc'] . '</td>';
                                echo '<td> ' . $row['price'] . '</td>';
                                echo '<td><a href="deveditiap.php?iapid=' . $row["iap_id"] . '">Edit</td>';
                                echo '</tr>';
                            }
                        }
                        ?>
