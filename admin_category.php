        ...
        <div class="container">
            ...
            <div id="responsive-nav">
                ...
                <ul class="main-nav nav navbar-nav">
                    ...
                    <li class="active"><a href="admin_category.php">Edit Categoty</a></li>
    ...
    <div id="breadcrumb" class="ass">
        ...
        <div class="container">
            ...
            <table style="width:100%;border: 1px solid">
                    <col width="500px">
                    <col width="50px">
					<th style="background-color:#ddd;">Category</th>
                    ...
                    while ($row = $result->fetch_array()) { ?>
                        <tr>
                            <td><?= $row['cat_name'] ?></td>
                            <td style="text-align:center;"><a href="editcate.php?catid=<?=$row['cat_id']?>"><img src="./images/Modify.png"></a></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
