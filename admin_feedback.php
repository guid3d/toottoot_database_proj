    ...
    <div id="breadcrumb" class="ass">
        ...
        <div class="container">
            ...
            <table style="width:100%;border: 1px solid">
					...
					<col width="600px">
                    <col width="50px">
					<th style="background-color:#ddd;">E-mail</th>
					<th style="background-color:#ddd;">Title</th>
                    <th style="background-color:#ddd;">Feedback</th>
					<th style="background-color:#ddd;">Del</th>
                    <?php
                    ...
                    while ($row = $result->fetch_array()) { ?>
                        <tr>
							...
							<td><?= $row['fb_title'] ?></td>
							<td><?= $row['fb_body'] ?></td>
                            <td style="text-align:center;"><a href='delinfo.php?fbid=<?=$row['fb_id']?>'><img src="./images/Delete.png"></a></td>
                        </tr>
                    <?php } ?>
                </table>
            </div>
