...
<body>
    ...
    <div>
        ...
        <div align="left" >
            ...
            width: 90%;
            display: block;">
                <div><input type="text" name="appname" placeholder="Application Name" style="width: 500px;"> </div>
                <input type="file" name="fileToUpload" id="fileToUpload">
                <div><textarea name="appshort" rows="2" cols="50" placeholder="Short Description"></textarea></div>
                <div><textarea name="applong" rows="5" cols="50" placeholder="Long Description"></textarea></div>
                <div><input type="text" name="price" placeholder="$0.99" style="width: 150px;"></div>
                <div><input type="text" name="version" placeholder="Version" style="width: 150px;"></div>
                <div><textarea name="changelog" rows="2" cols="50" placeholder="Changelog"></textarea></div>
                <input type="hidden" name="edittype" value="new">
                <div>Categories<select name="cat">
