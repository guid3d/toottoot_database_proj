...
include("connect.php");
$id = $_GET['iapid'];
$q = 'SELECT app_name,i.price AS "price",iap_desc AS "desc"  FROM applications JOIN inapp_purchase i WHERE applications.app_id = i.app_id and iap_id= ' . $_GET['iapid'];
// echo $q;
if ($res = $conn->query($q)) {
    $row = $res->fetch_array();
}
    ...
    <!-- HEADER -->
        ...
        <div>
            ...
            display: block;">
                    ...
                    <div><input type="text" disabled   name="appname" placeholder="Application Name" style="width: 500px;" value="<?php echo $row['app_name']; ?>"> </div>
                    <div><input type="text" name="price" placeholder="Price" style="width: 150px;" value="<?php echo $row['price']; ?>"></div>
                    <div><textarea name="desc" rows="5" cols="50" placeholder="Description"><?php echo $row['desc']; ?></textarea></div>
